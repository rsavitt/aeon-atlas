...
> Auto-generated by `scripts/atlas.mjs` on 2026-06-05. Which upstream-enabled skills are systematically turned off by forks?
...
Ships **3** skill(s) enabled by default. Disable rates across **157** forks:

| Skill | Disabled by | Rate |
|---|---:|---:|
| `fleet-skill-adoption` | 116 / 157 | **74%** |
| `skill-enabler` | 109 / 157 | **69%** |
| `heartbeat` | 0 / 157 | **0%** |
...
- **`aaronjmars/aeon` → `fleet-skill-adoption`** — disabled by 74% of forks (116 / 157).
- **`aaronjmars/aeon` → `skill-enabler`** — disabled by 69% of forks (109 / 157).
