...
Ships **3** skill(s) enabled by default. Disable rates across **141** forks:

| Skill | Disabled by | Rate |
|---|---:|---:|
| `fleet-skill-adoption` | 116 / 141 | **82%** |
| `skill-enabler` | 111 / 141 | **79%** |
| `heartbeat` | 0 / 141 | **0%** |
...
- **`aaronjmars/aeon` → `fleet-skill-adoption`** — disabled by 82% of forks (116 / 141).
- **`aaronjmars/aeon` → `skill-enabler`** — disabled by 79% of forks (111 / 141).
