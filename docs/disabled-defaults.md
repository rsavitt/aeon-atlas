...
> Auto-generated by `scripts/atlas.mjs` on 2026-06-03. Which upstream-enabled skills are systematically turned off by forks?
...
Ships **3** skill(s) enabled by default. Disable rates across **152** forks:

| Skill | Disabled by | Rate |
|---|---:|---:|
| `fleet-skill-adoption` | 116 / 152 | **76%** |
| `skill-enabler` | 110 / 152 | **72%** |
| `heartbeat` | 0 / 152 | **0%** |
...
- **`aaronjmars/aeon` → `fleet-skill-adoption`** — disabled by 76% of forks (116 / 152).
- **`aaronjmars/aeon` → `skill-enabler`** — disabled by 72% of forks (110 / 152).
