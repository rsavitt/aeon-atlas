...
- **18 operators** with ≥ 2 atlas artifacts (multi-fork or fork+pack/ecosystem)
...
Generated by `scripts/atlas.mjs` from `atlas.json` on 2026-06-01. The same data backs the [interactive Cytoscape map](../atlas.html), the [ecosystem digest](../ecosystem/), the [packs page](../skill-packs/), the [innovations report](../innovations/), and the [disabled-defaults audit](../disabled-defaults/).
