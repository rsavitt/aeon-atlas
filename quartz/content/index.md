...
- **165 forks** of [`aaronjmars/aeon`](https://github.com/aaronjmars/aeon) — sample: [[forks/aaronjmars-aeon|upstream]]
- **21 operators** with ≥ 2 atlas artifacts (multi-fork or fork+pack/ecosystem)
- **49 ecosystem projects** publicly identifying as built on Aeon
...
Generated by `scripts/atlas.mjs` from `atlas.json` on 2026-06-05. The same data backs the [interactive Cytoscape map](../atlas.html), the [ecosystem digest](../ecosystem/), the [packs page](../skill-packs/), the [innovations report](../innovations/), and the [disabled-defaults audit](../disabled-defaults/).
