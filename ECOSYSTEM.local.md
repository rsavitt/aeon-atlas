# Local ecosystem supplements

Additional projects that build on Aeon but aren't yet listed in
[`aaronjmars/aeon/ECOSYSTEM.md`](https://github.com/aaronjmars/aeon/blob/main/ECOSYSTEM.md).
`scripts/atlas.mjs` merges this table with the upstream one; same format.
