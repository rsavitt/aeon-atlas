...
function writeUniverseContent(graph, operators) {
  ...
  const indexLines = [
    ...
    `## Source data`,
    ``,
    `Generated by \`scripts/atlas.mjs\` from \`atlas.json\` on ${graph.generatedAt.slice(0, 10)}. The same data backs the [interactive Cytoscape map](https://swarm-ai-research.github.io/aeon-atlas/atlas.html), the [ecosystem digest](https://swarm-ai-research.github.io/aeon-atlas/ecosystem/), the [packs page](https://swarm-ai-research.github.io/aeon-atlas/skill-packs/), the [innovations report](https://swarm-ai-research.github.io/aeon-atlas/innovations/), and the [disabled-defaults audit](https://swarm-ai-research.github.io/aeon-atlas/disabled-defaults/).`,
  ];
